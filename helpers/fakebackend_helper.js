...
// get workspace
export const getWorkspaces = () => get(url.GET_WORKSPACE)

// get roadmaps
export const getRoadmaps = () => get(url.GET_ROADMAP)

// get transaction
export const getTransactions = page =>
  get(`${url.GET_TRANSACTION}/`, { params: page })
...
export const getDashboardRecord = () => get(url.GET_DASHBOARD_DATA)

export const getMonthlyChartRecord = () => get(url.GET_MONTHLY_CHART)
