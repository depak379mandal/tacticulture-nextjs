...
//LOGIN
export const POST_FAKE_LOGIN = "/login" // roadmap
export const POST_FAKE_JWT_LOGIN = "/login" // roadmap
export const POST_FAKE_PASSWORD_FORGET = "/fake-forget-pwd"
export const POST_FAKE_JWT_PASSWORD_FORGET = "/jwt-forget-pwd"
export const SOCIAL_LOGIN = "/social-login"

//PROFILE
export const POST_EDIT_JWT_PROFILE = "/change-password" //roadmap update admin password
...
//CONTACTS
export const GET_USERS = "/users-list" // roadmap
export const GET_USER_PROFILE = "/user"
export const ADD_NEW_USER = "/add/user"
export const UPDATE_USER = "/update-status" // roadmap
export const DELETE_USER = "/delete/user"

//WORKSPACE
export const GET_WORKSPACE = "/workspace-list" // roadmap

//WORKSPACE
export const GET_ROADMAP = "/roadmap-list" // roadmap

//TRANSACTION
export const GET_TRANSACTION = "/latest-transaction" // roadmap

//NOTIFICATION
export const GET_NOTIFICATION = "/notification-list/" // roadmap
...
export const GET_DASHBOARD_DATA = "/dashboard" // roadmap

export const GET_MONTHLY_CHART = "/month-wise-earning-report" //  MONTHLY CHART
