...
const Dashboard = props => {
  ...
  // const reports = [
  //   { name: "Users", iconClass: "fa-users", value: "1,235" },
  //   { name: "Active Users", iconClass: "fa-users", value: "500" },
  //   { name: "Inactive Users", iconClass: "fa-user-slash", value: "700" },
  //   { name: "Verified Users", iconClass: "fa-users", value: "500" },
  //   { name: "Unverified Users", iconClass: "fa-user-slash", value: "700" },
  //   {
  //     name: "Workspace",
